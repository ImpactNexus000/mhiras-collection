...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: "We accept secure payments via Paystack — debit/credit card, bank transfer, or USSD. Pay-on-delivery isn't available across all zones yet — we'll add it as we expand.",
  },
  {
